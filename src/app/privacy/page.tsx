      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-6 text-gray-300">
          ...
          <section>
            ...
            <p>
              Welcome to XFLIX ("we," "our," or "us"). We are committed to protecting your privacy and ensuring you have a positive experience on our website. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services.
            </p>
          </section>
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-white mb-3 mt-4">2.2 Cookies and Tracking Technologies</h3>
            <p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>Communicate with you about updates and promotional content</li>
          ...
          <section>
            ...
            <p className="mb-3">
              XFLIX is an ad-supported service. We work with third-party advertising partners to display advertisements on our website. These partners may use cookies and similar technologies to collect information about your browsing activities to provide relevant advertising.
            </p>
            <p className="mb-3">Our advertising partners include:</p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>Google AdSense</li>
              <li>Other ad networks and exchanges</li>
            </ul>
            <p className="mt-3">
              These third parties may collect information such as your IP address, browser type, pages visited, and time spent on our site to serve targeted advertisements.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              Our website may contain links to third-party websites and services, including video streaming providers. We are not responsible for the privacy practices of these third parties. We encourage you to read their privacy policies before providing any information.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Our service is not intended for children under 13 years of age. We do not knowingly collect personally identifiable information from children under 13. If you are a parent or guardian and believe your child has provided us with personal information, please contact us.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-gray-800 p-4 rounded-lg">
              <p>Email: privacy@xflix.com</p>
              <p>Website: https://xflix.com</p>
            </div>
          </section>
        </div>
      </div>
